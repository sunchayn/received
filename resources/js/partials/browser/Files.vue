<template>
    <section class="flex-1 files relative">
        ...
        <header class="files_header" ref="table-header">
            <span class="files_column files_column--wide w-4/12">File</span>
            <span class="files_column files_column--small">Extension</span>
            <span class="files_column files_column--small">Size</span>
        ...
        <div class="files_content" @scroll="moveTableHeader">
            <template v-if="folder">
                <div class="files_row"
                     ...
                     :key="file.id"
                >
                    <span class="files_column files_column--wide w-4/12">{{file.filename}}</span>
                    <span class="files_column files_column--small">{{file.extension}}</span>
                    <span class="files_column files_column--small">{{file.size}}</span>
                    <span class="files_column w-2/12">{{file.type}}</span>
                    <span class="files_column w-2/12">{{file.sent_on}}</span>
                    <span class="files_column overflow-visible w-2/12">
