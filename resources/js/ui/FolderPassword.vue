<template>
    <fragment>
        <div v-show="sharing" class="fixed bg-black opacity-25 top-0 right-0 left-0 bottom-0 z-40"></div>
        <div
            v-show="sharing"
            class="fixed z-50 border border-gray-200 shadow-md mt-2 bg-white p-5 max-w-full"
            style="left: 50%;top:50%;transform: translate(-50%, -50%); width: 80%; max-width: 360px;"
        >
