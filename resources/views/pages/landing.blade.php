...
@section('content')
    ...
    >
        ...
        <!-- ** -->
        <svg
            class="absolute min-h-screen top-0 bottom-0 right-0 left-0 pointer-events-none"
        ...
        <svg
            class="absolute min-h-screen bottom-0 right-0 left-0 pointer-events-none"
        ...
        <div class="flex-1 flex flex-col h-full relative z-10">
            ...
            <div class="my-auto">
                <div class="container flex flex-wrap md:flex-no-wrap max-w-6xl">
                    <div class="w-full mb-10 md:mb-0 md:w-1/2 lg:w-2/3 md:mr-10">
                        ...
                        <div class="bg-lightGray text-sm text-gray-700 inline-block py-2 pr-3 mb-12 relative">
                            ...
                            <div class="relative z-10 inline-flex items-center">
                                ...
                                <a href="https://dev.to/devteam/announcing-the-twilio-hackathon-on-dev-2lh8" target="_blank" class="ml-10 text-gray-700 hover:text-gray-900 whitespace-no-wrap">learn more</a>
                            </div>
                        </div>

                        <h1 class="text-2xl md:text-3xl lg:text-4xl font-black text-black max-w-sm leading-tight">Public bucket for receiving files</h1>
                        <p class="text-lg md:text-xl lg:text-2xl text-gray-700 mb-5 max-w-lg">
