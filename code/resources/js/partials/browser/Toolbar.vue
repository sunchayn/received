            ...
            <header class="browser_toolbar" v-if="folder">
                ...
                <div class="ml-auto flex items-center">
                    ...
                    <div class="mr-2 relative">
                        ...
                        <button class="button button--outline" @click="sharing = !sharing" v-if="! folder.is_shared">
                        ...
                        <button class="button button--outline" @click="revokeAccess" v-else>
                        ...
                        >
                            <template v-if="! shareData.shared">
                                ...
                                <div class="flex">
                                    ...
                                    <button type="submit" class="button button--outline flex-1" @click="sharing = false">Dismiss</button>
                                </div>
                            </template>
                            ...
                            <template v-else>
                                <div class="text-center">
                                    ...
                                    <button type="submit" class="button button--outline w-full" @click="sharing = false">Dismiss</button>
                                </div>
                            </template>
                        </div>
                    </div>

                    <button class="button button--outline mr-2">
                    ...
                    <button class="button button--outline button--red" @click="deleted=true">
